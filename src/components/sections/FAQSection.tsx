...
const faqData: FAQItem[] = [
  ...
  },
  {
    id: '14',
    category: 'security',
    question: 'Как реализуется fine-tuning моделей на наших корпоративных данных?',
    answer: 'Используем безопасные методы дообучения: данные остаются в вашей инфраструктуре, применяем федеративное обучение и differential privacy. Создаём специализированные модели, которые понимают специфику именно вашего бизнеса, при этом сохраняя конфиденциальность.'
  },
  {
    id: '15',
    category: 'technical',
  ...
  },
  {
    id: '16',
    category: 'technical',
    question: 'Можете ли вы настроить ИИ-аналитику с предиктивными моделями для прогнозирования?',
    answer: 'Да! Разрабатываем предиктивные модели для прогнозирования продаж, поведения клиентов, потребности в товарах, рисков и трендов. Используем машинное обучение, временные ряды и нейронные сети для точных прогнозов на основе ваших исторических данных.'
  }
];
