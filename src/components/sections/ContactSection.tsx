            ...
            <div className="space-y-8">
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-blue-200 text-xs">@aironlab_team</p>
                      </div>
                    </div>
                  ...
                  {/* Instagram */}
                  <a 
                    href="https://instagram.com/aironlab" 
                    target="_blank" 
                    rel="noopener noreferrer"
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-pink-200 text-xs">@aironlab</p>
                      </div>
                    </div>
                  ...
                  {/* Habr */}
                  <a 
                    href="https://habr.com/users/aironlab" 
                    target="_blank" 
                    rel="noopener noreferrer"
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      <div className="w-10 h-10 bg-gradient-to-r from-gray-600 to-gray-700 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                        <img 
                          src="/images/social/teletype.svg" 
                          alt="Teletype"
                          className="w-5 h-5"
                        />
                      </div>
